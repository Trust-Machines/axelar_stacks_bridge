...
(define-constant err-invalid-length-txid (err u1011))

(define-constant err-proof-too-short (err u2000))

(define-constant err-block-header-too-short (err u3000))
(define-constant err-invalid-block-height (err u3001))
(define-constant err-block-height-header-mismatch (err u3002))
(define-constant err-merkle-proof-invalid (err u3003))
