...
### 6. `deploy-remote-interchain-token`
...
```clarity
{
    ...
    sender: 'ST1DRWEN0XDBPSEX3XVXK57NNT03B6ZZ0D58N36RS.interchain-token-service,
    }
```
...
'decoded-wrapped-wrapped-payload,' "{ amount: u100000, data: 0x00, destination-address: 0x00, source-address: 'ST1DRWEN0XDBPSEX3XVXK57NNT03B6ZZ0D58N36RS, token-id: 0x753306c46380848b5189cd9db90107b15d25decccd93dcb175c0098958f18b6f, type: u0 }"
```
...
```clarity
{
  ...
  destination-contract-address: "ST1DRWEN0XDBPSEX3XVXK57NNT03B6ZZ0D58N36RS.interchain-token-service",
...
'payload-hash:' '0x8488259c3537e21e92750cc757a4b99377c5149ea986e2eff7716fdaf8c4ace8'
'sender:' 'ST1DRWEN0XDBPSEX3XVXK57NNT03B6ZZ0D58N36RS.interchain-token-service'
'decoded-wrapped-payload,' `{ token-address: 'ST1DRWEN0XDBPSEX3XVXK57NNT03B6ZZ0D58N36RS.sample-sip-010, token-id: 0x289df9e77347122b6306bc2db1fa9387bb8b851d685ff3ee92d18335abd1c10c, token-manager-address: 'ST1DRWEN0XDBPSEX3XVXK57NNT03B6ZZ0D58N36RS.token-manager, token-type: u2, type: "verify-token-manager" }`
```
