...
export const ITF_ERRORS = {
  ...
  "ERR-SERVICE-NOT-DEPLOYED": Cl.uint(211054),
  "ERR-GATEWAY-NOT-DEPLOYED": Cl.uint(211055),
  "ERR-TOKEN-NOT-DEPLOYED": Cl.uint(211056),
  "ERR-MANAGER-NOT-DEPLOYED": Cl.uint(211057),
  "ERR-NOT-PROXY": Cl.uint(211058),
  "ERR-INVALID-IMPL": Cl.uint(210211),
  "ERR-TOKEN-NOT-FOUND": Cl.uint(211059),
